...
- **`/mmry:foundation-status`** reports whether your Foundation directives are actually reaching this assistant right now: whether re-injection is on, whether the locally stored copy matches what MMRY holds for your account, how many directives and characters it is, and how long ago it was last sent. Read-only.
